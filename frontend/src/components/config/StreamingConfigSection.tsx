						...
						<div className="min-w-0">
							<div className="flex items-center gap-2">
								...
								<div
									...
									data-tip="Number of articles to download ahead of the current playback position. Higher values provide smoother streaming on unstable connections but use more memory."
								>
				...
				<div className="flex items-center justify-between rounded-2xl border-2 border-base-300/80 bg-base-200/60 p-6">
					<div className="min-w-0">
						<div className="flex items-center gap-2">
							...
							<div
								className="tooltip tooltip-right"
								data-tip="Decodes and stores Usenet articles on local disk. Highly recommended if not using RClone VFS cache."
							>
								<Info className="h-3.5 w-3.5 text-base-content/40" />
							</div>
						</div>
				...
				<div className="space-y-3 rounded-2xl border-2 border-base-300/80 bg-base-200/60 p-6">
					<div className="min-w-0">
						<div className="flex items-center gap-2">
							...
							<div
								className="tooltip tooltip-right"
								data-tip="The absolute path where cached segments will be stored. SSD is strongly recommended."
							>
								<Info className="h-3.5 w-3.5 text-base-content/40" />
							</div>
						</div>
