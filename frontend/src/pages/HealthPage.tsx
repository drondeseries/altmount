...
import { CalendarClock, FileCheck, RefreshCw, RotateCcw, Settings, ShieldCheck, Trash2 } from "lucide-react";
				...
				<div className="flex items-center gap-2">
					<div className="dropdown">
						...
						<ul className="dropdown-content menu z-[1] mt-2 w-52 rounded-box border border-base-200 bg-base-100 p-2 shadow-lg">
							...
							{(config?.import?.import_strategy === "SYMLINK" || !!config?.import?.pin_symlink_timestamp) && (
							<li>
								<button
									type="button"
