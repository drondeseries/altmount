			...
			<div className="flex items-center justify-between border-base-200/50 border-b p-4">
				<div>
					...
					<p className="text-[12px] text-base-content/60">
						Real-time topology of active providers, connection speeds, and health metrics
					</p>
				</div>
				...
				>
					...
					<defs>
						...
						<pattern id="hud-grid" width="25" height="25" patternUnits="userSpaceOnUse">
							<path d="M 25 0 L 0 0 0 25" fill="none" stroke="rgba(59, 130, 246, 0.015)" strokeWidth="1" />
							<circle cx="0" cy="0" r="1.2" fill="rgba(59, 130, 246, 0.05)" />
						</pattern>
					...
					{/* Cyber Labels */}
					<text x="45" y="25" className="fill-blue-500/50 font-bold font-mono text-[10px] uppercase tracking-wider">
						Telemetry Active
					</text>
					<text x="45" y="295" className="fill-blue-500/40 font-mono text-[10px] tracking-wider">
						SYSTEM SECURE
					</text>
					...
					<g className="cursor-pointer" transform="translate(0, 0)">
						...
						<text
							...
							y="204"
							textAnchor="middle"
							className="fill-primary/80 font-bold font-mono text-[10px] uppercase tracking-widest"
						>
							CORE
						</text>
					</g>
					...
					<g transform="translate(0, 0)">
						...
						<g transform="translate(557, 34)">
							...
							<text x="18" y="10" className="fill-cyan-400 font-bold font-mono text-[10px] uppercase tracking-wider">
								{targetedNode ? "TARGET SELECTED" : "SYSTEM OVERVIEW"}
							</text>
						</g>
						...
						{!targetedNode ? (
							...
							<g transform="translate(557, 62)">
								{/* Tech details */}
								<g transform="translate(0, 0)">
									<text x="0" y="10" className="fill-slate-400 font-bold font-mono text-[10px] uppercase tracking-wider">
										SYSTEM:
									</text>
									<text x="75" y="10" className="fill-emerald-400 font-bold font-mono text-[10px]">
										ONLINE // ACTIVE
									</text>

									<text x="0" y="24" className="fill-slate-400 font-mono text-[10px]">
										PROVIDERS:
									</text>
									<text x="75" y="24" className="fill-slate-200 font-mono text-[10px]">
										{nodes.length} PROVIDERS
									</text>

									<text x="0" y="38" className="fill-slate-400 font-mono text-[10px]">
										CONNECTIONS:
									</text>
									...
									<text x="0" y="52" className="fill-slate-400 font-mono text-[10px]">
										SECURE:
									</text>
									<text x="75" y="52" className="fill-emerald-500/80 font-semibold font-mono text-[10px]">
										TLSv1.3
									</text>
								</g>
								...
								<g transform="translate(0, 68)">
									...
									<text x="0" y="24" className="fill-cyan-400 font-bold font-mono text-[14px]">
								...
								<g transform="translate(0, 138)">
									...
									<text x="24" y="21" className="fill-blue-400 font-medium font-mono text-[9.5px]">
							...
							<g transform="translate(557, 60)">
								...
								<g transform="translate(0, 4)">
									<text x="0" y="8" className="fill-slate-400 font-mono text-[10px]">
										PROVIDER:
									</text>
									<text x="75" y="8" className="fill-white font-bold font-mono text-[10px] tracking-wide">
										{getProviderBrandName(targetedNode.provider.host).toUpperCase()}
									</text>

									<text x="0" y="21" className="fill-slate-400 font-mono text-[10px]">
										HOST:
									</text>
								...
								<g transform="translate(0, 44)">
									...
									<text x="80" y="8" className={`font-bold font-mono text-[10px] ${targetedNode.textColor}`}>
									...
									{/* Connections */}
									<text x="0" y="34" className="fill-slate-400 font-mono text-[10px]">
										CONNECTIONS:
									</text>
									...
									{/* Speed */}
									<text x="0" y="47" className="fill-slate-400 font-mono text-[10px]">
										SPEED:
									</text>
									...
									<text x="0" y="60" className="fill-slate-400 font-mono text-[10px]">
										24H DATA:
									</text>
									...
									{/* Error volume */}
									<text x="0" y="73" className="fill-slate-400 font-mono text-[10px]">
										FAILURES:
									</text>
									<text x="80" y="73" className={`font-bold font-mono text-[10px] ${targetedNode.provider.error_count > 0 ? "text-rose-400" : "text-slate-400"}`}>
						...
						<g transform="translate(557, 252)">
							...
							<text x="35" y="6" className="fill-slate-500 font-mono text-[9px] uppercase tracking-wide">
								{targetedNode ? `STATUS: ${targetedNode.provider.state.toUpperCase()}` : "MONITORING PROVIDERS..."}
							</text>
						</g>
					</g>
				</svg>
